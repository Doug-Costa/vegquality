<header id="navbar" class="header">
  <div class="container">
    <div class="navbar-container">
      ...
      <nav class="nav-links">
        ...
        <a href="{{ url('/radar') }}" class="nav-link {{ request()->is('radar') || request()->is('radar*') ? 'active' : '' }}">Blog</a>
  ...
  <div id="mobile-menu" class="mobile-menu">
    <div class="mobile-menu-container">
      ...
      <a href="{{ url('/radar') }}" class="mobile-nav-link {{ request()->is('radar') || request()->is('radar*') ? 'active' : '' }}">Blog</a>
